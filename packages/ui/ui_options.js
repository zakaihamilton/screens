...
package.ui.options = function UIOptions(me) {
    ...
    me.load = function(component, object, defaults) {
        ...
        if(object) {
            storageKey += "." + me.package.core.property.get(object, "key");
        }
        var validKey = me.package.storage.cache.validKey(storageKey);
        var value = me.package.core.property.get(me.package.storage.cache[storage], validKey);
        ...
        return {
            ...
            set: function (object, value) {
                ...
                if(storage) {
                    ...
                    var validKey = me.package.storage.cache.validKey(storageKey);
                    me.package.core.property.set(me.package.storage.cache[storage], validKey, JSON.stringify(options));
                }
            }
        };
    };
