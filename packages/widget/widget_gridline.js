...
package.widget.gridLine = function WidgetGridLine(me) {
    ...
    me.line = {
        ...
        set: function(object, value) {
            ...
            var firstPoint = [coords[0], coords[1]];
            var secondPoint = [coords[2], coords[3]];
            var thirdPoint = [coords[4], coords[5]];
            ...
            borderBottom = secondPoint[1] === thirdPoint[1];
            if(borderLeft) {
                me.set(object, "ui.style.borderLeft", "1px solid " + color);
            }
            if(borderRight) {
                me.set(object, "ui.style.borderRight", "1px solid " + color);
            }
            if(borderTop) {
                me.set(object, "ui.style.borderTop", "1px solid " + color);
            }
            if(borderBottom) {
                me.set(object, "ui.style.borderBottom", "1px solid " + color);
            }
        }
    };
};
