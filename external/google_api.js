...
(function () {
    ...
    var D = function (a, b, c) {
        ...
        xa = /[\ud800-\udbff][\udc00-\udfff]|[^!-~]/g,
        ya = new RegExp(/(%([^0-9a-fA-F%]|[0-9a-fA-F]([^0-9a-fA-F%])?)?)*/.source + /%($|[^0-9a-fA-F]|[0-9a-fA-F]($|[^0-9a-fA-F]))/.source, "g"),
    ...
    var Ha = function (a, b, c, d) {
        ...
        La = function (a) {
            if (Ja()) a();
                ...
                t.addEventListener ? (t.addEventListener("load", c, !1), t.addEventListener("DOMContentLoaded", c, !1)) : t.attachEvent && (t.attachEvent("onreadystatechange", function () {
    ...
    var yb = function (a) {
        ...
        N = function (a, b, c) {
            if (b && "object" === typeof b) for (var d in b) !Object.prototype.hasOwnProperty.call(b, d) || c && "___goc" === d && "undefined" === typeof b[d] || (a[d] && b[d] && "object" === typeof a[d] && "object" === typeof b[d] && !Ab(a[d]) && !Ab(b[d]) ? N(a[d], b[d]) : b[d] && "object" === typeof b[d] ? (a[d] = Ab(b[d]) ? [] : {}, N(a[d], b[d])) : a[d] = b[d])
        },
        Bb = function (a) {
            if (a && !/^\s+$/.test(a)) {
        ...
        Db = function (a) {
            ...
            for (e = 0; e < d.length; ++e) d[e].getAttribute("gapi_processed") || (d[e].setAttribute("gapi_processed", !0), (f = d[e]) ? (g = f.nodeType, f = 3 == g || 4 == g ? f.nodeValue : f.textContent || f.innerText || f.innerHTML || "") : f = void 0, (f = Bb(f)) && b.push(f));
            a && Cb(c, a);
            d = yb("cd");
            a = 0;
    ...
    var Sb = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/u\/(\d)\//,
        ...
        Ub = function (a) {
            ...
            "string" === typeof b && 254 < b.length && (b = null);
            null == b && (a = a || window.location.href, b = D(a, "authuser") || null, null == b && (b = (b = a.match(Sb)) ? b[1] : null));
    ...
    var Wb, Q, R = void 0,
        ...
        U = function (a, b) {
            ...
            if ("undefined" !== d) {
                ...
                b = [];
                var e = T(a);
                if (null != a && "function" === typeof a.toJSON && (Object.prototype.hasOwnProperty.call(a, "toJSON") || (e !== bc || a.constructor !== Array && a.constructor !== Object) && (e !== ac || a.constructor !== Array && a.constructor !== Object) && e !== $b && e !== Xb && e !== Zb && e !== Yb)) return U(a.toJSON.call(a), c);
                if (null == a) b[b.length] = "null";
                    ...
                    if (e === bc && T(a.length) === Xb) {
                        b[b.length] = "[";
                        var f = 0;
                        for (d = Number(a.length) >> 0; f < d; ++f) f && (b[b.length] = ","), b[b.length] = U(a[f], c) || "null";
                        b[b.length] = "]"
                        ...
                        b[b.length] = "{";
                        d = 0;
                        for (f in a) Object.prototype.hasOwnProperty.call(a, f) && (e = U(a[f], c), void 0 !== e && (d++ && (b[b.length] = ","), b[b.length] = U(f), b[b.length] = ":", b[b.length] = e));
                        b[b.length] = "}"
                    } else
                        return
                }
        ...
        if (null != a) {
            ...
            for (var c = b - this.l, d = 0, e = this.G, f = this.v; d < b;) {
                ...
                if ("string" == typeof a) for (; d < b;) {
                    ...
                    for (; d < b;) if (e[f] = a[d], ++f, ++d, f == this.l) {
                        Bc(this, e);
                        f = 0;
                        break
                    }
        ...
        ld = function (a) {
            for (var b = x(), c = 0 != a.nodeName.toLowerCase().indexOf("g:"), d = 0, e = a.attributes.length; d < e; d++) {
                var f = a.attributes[d],
                    g = f.name,
                    h = f.value;
                0 <= la.call(jd, g) || c && 0 != g.indexOf("data-") || "null" === h || "specified" in f && !f.specified || (c && (g = g.substr(5)), b[g.toLowerCase()] = h)
            }
            a = a.style;
        ...
        nd = function () {
            ...
            Pb(function (b) {
                if (a !== b.id && 4 != b.state && "share" != b.type) {
                    ...
                    if (f) {
                        var g = id(d, b, 0);
                        g ? (f = f.parentNode, e.replace(/#.*/, "").replace(/(\?|&)ic=1/, "") !== g.replace(/#.*/, "").replace(/(\?|&)ic=1/, "") && (b.dontclear = !0, b.rd = !0, b.ri = !0, b.type = d, md(f, b), (d = P[f.lastChild.id]) && (d.oid = c), Qb(c, 4))) : delete P[c]
                    } else delete P[c]
                }
            })
        };
    ...
    var xd = function (a, b) {
        ...
        yd = function (a, b, c, d, e, f, g) {
            switch (Ed(b, a, f)) {
                ...
                case 1:
                    if (b.parentNode) {
                        for (var h in c) {
                            if (f = z(c, h)) f = c[h], f = !!f && "object" === typeof f && (!f.toString || f.toString === Object.prototype.toString || f.toString === Array.prototype.toString);
                            if (f) try {
                                c[h] = wc(c[h])
                            } catch (y) {
                                delete c[h]
                        ...
                        b = c.ownerDocument || v;
                        k = 0;
                        do e = h.id || ["I", Uc++, "_", (new Date).getTime()].join("");
        ...
        Ed = function (a, b, c) {
            if (a && 1 === a.nodeType && b) {
                if (c) return 1;
                if (V[b]) {
                    if (Oa[a.nodeName.toLowerCase()]) return (a = a.innerHTML) && a.replace(/^[\s\xa0]+|[\s\xa0]+$/g, "") ? 0 : 1
                } else {
                    if (pd[b]) return 0;
                    if (od[b]) return 1
                }
...
gapi.load("", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en.4CFxRrSvxq0.O/am\u003dwQE/d\u003d1/rs\u003dAGLTcCNk69adtZYbtfIwiKKtklVg1Iw-vg/m\u003d__features__",
